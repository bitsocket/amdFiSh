...
"asmFish\fasm.exe" "asmFish\asmFishW_base.asm"      -m 50000 "Windows\amdFishW_%datestamp%_base.exe"
"asmFish\fasm.exe" "asmFish\asmFishW_popcnt.asm"    -m 50000 "Windows\amdFishW_%datestamp%_popcnt.exe"
"asmFish\fasm.exe" "asmFish\asmFishW_bmi2.asm"      -m 50000 "Windows\amdFishW_%datestamp%_bmi2.exe"
"asmFish\fasm.exe" "asmFish\asmFishL_base.asm"      -m 50000 "Linux\amdFishL_%datestamp%_base"
"asmFish\fasm.exe" "asmFish\asmFishL_popcnt.asm"    -m 50000 "Linux\amdFishL_%datestamp%_popcnt"
"asmFish\fasm.exe" "asmFish\asmFishL_bmi2.asm"      -m 50000 "Linux\amdFishL_%datestamp%_bmi2"
